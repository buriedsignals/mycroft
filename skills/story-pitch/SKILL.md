...
attribution: "Adapted from jamditis/claude-skills-journalism (journalism-core/skills/story-pitch) at 2097d218. Original author: Joe Amditis. MIT License."
---

# Story pitch guide

Good stories die in bad pitches. This skill covers pitch structure, angle development, and outlet-specific formatting. (Adjacent: the `copywriting` skill owns outlet voice for the story itself; this skill owns the pitch.)
...
Adapted from [claude-skills-journalism](https://github.com/jamditis/claude-skills-journalism/tree/2097d218c6f38a8e7be77ce5f0ff6c2e39671f13/journalism-core/skills/story-pitch) by **Joe Amditis**, released under MIT License. Vendored at `2097d218` with localization and integration edits.
