...
attribution: "Adapted from jamditis/claude-skills-journalism (journalism-core/skills/interview-prep) at 2097d218. Original author: Joe Amditis. MIT License."
---
...
- [ ] Any deleted content recovered? (Wayback Machine / Archive.today)
...
> **Jurisdiction note:** the guidance below is US consent law. In the EU/UK, recording interviews is governed by GDPR/UK-GDPR and national law — journalistic-purposes exemptions vary by country; when in doubt, get explicit consent on the recording.
...
Recording backup, transcription tooling, and quote-verification mechanics are out of scope here — the notes below cover the post-interview *editorial* steps.

### Immediate (same day)
- [ ] Back up recording (consistent storage location and file naming)
...
Adapted from [claude-skills-journalism](https://github.com/jamditis/claude-skills-journalism/tree/2097d218c6f38a8e7be77ce5f0ff6c2e39671f13/journalism-core/skills/interview-prep) by **Joe Amditis**, released under MIT License. Vendored at `2097d218` with localization and integration edits.
