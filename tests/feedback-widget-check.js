...
assert.match(html, /data-project-tag="mycroft"/, 'Mycroft project tag is embedded as metadata');
...
assert.match(api, /PROJECT_TAG\s*=\s*['"]mycroft['"]/, 'serverless backend applies Mycroft label');
