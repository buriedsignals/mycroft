#!/usr/bin/env python3
"""Validation helpers for Mycroft shell-safety checks.

Mirrored from the Spotlight bundle's `spotlight_safe.py`. Each public bundle
ships its own copy so installs are self-contained — kept in sync manually.
"""
...
def main(argv: list[str]) -> int:
    parser = argparse.ArgumentParser(description="Mycroft shell-safety validation helper")
